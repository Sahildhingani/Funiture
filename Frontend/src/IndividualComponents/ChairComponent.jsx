...
import banner from "../images/BannerChair.png";
...
function Chair() {
  ...
  async function Gettheitem(pageNo) {
    try {
      ...
      console.log("chair side error", error);
    }
  }
  ...
  return (
    <div className="flex flex-col">
      ...
      <div className="flex justify-center items-center relative">
        <img className="h-96 w-7xl rounded-4xl mt-15" src={banner} alt="" />
